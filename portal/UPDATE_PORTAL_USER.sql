...
Date: 2019-01-18 11:18:51
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Procedure structure for UPDATE_PORTAL_USER
-- ----------------------------
DROP PROCEDURE IF EXISTS `UPDATE_PORTAL_USER`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_PORTAL_USER`(IN P_USER_ID INT, IN P_USER_NAME VARCHAR(40), IN P_USER_REAL_NAME	VARCHAR(40), IN P_USER_STATE	INT, IN P_JOB_ID	INT, IN P_USER_ADDR	VARCHAR(80), IN P_USER_TEL	VARCHAR(20), IN P_USER_GLOBAL_ID	INT, IN P_USER_EMAIL	VARCHAR(60),  IN P_ROLE_IDS	VARCHAR(200), IN P_DEP_ID	INT,OUT P_ERROR_NO INT)
BEGIN
	DECLARE IDX INT;
