package com.quick.portal.authorizer.client;
 ...
 * <p>Title: MyCasClient.java</p>
 * 类修改者	修改日期
 * 修改说明
 * @version V1.0
 */
public class PortalCasClient extends CasClient {
	
	public PortalCasClient(final CasConfiguration configuration) {
		super(configuration);
	}
