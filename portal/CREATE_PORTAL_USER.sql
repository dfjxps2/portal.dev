...
Date: 2019-01-18 11:18:18
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Procedure structure for CREATE_PORTAL_USER
-- ----------------------------
DROP PROCEDURE IF EXISTS `CREATE_PORTAL_USER`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CREATE_PORTAL_USER`(IN USER_NAME VARCHAR(40)
	...
	, IN USER_EMAIL	VARCHAR(60), IN ROLE_IDS	VARCHAR(200)
	, IN DEP_ID	INT
  , OUT ERROR_NO INT)
BEGIN
